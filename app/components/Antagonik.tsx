          ...
          <div className="w-[45vw] max-w-[550px]">
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 138.4 30.29" className="w-full h-auto">
              ...
              <g>
                ...
                <path className="cls-1" d="m84.93,4.4h-4.1v1.82c-.46-.4-.96-.77-1.52-1.07-1.36-.74-2.82-1.12-4.4-1.12s-3.04.37-4.4,1.12c-1.36.74-2.44,1.78-3.25,3.1-.81,1.32-1.22,2.82-1.22,4.48s.41,3.16,1.22,4.48c.81,1.32,1.89,2.35,3.25,3.1,1.35.74,2.82,1.12,4.4,1.12s3.04-.37,4.4-1.12c1.35-.74,2.44-1.78,3.25-3.1.81-1.32,1.22-2.82,1.22-4.48s-.41-3.16-1.22-4.48c-.14-.23-.3-.44-.46-.65h2.83v-3.2Zm-5.38,11.11c-.47.83-1.11,1.49-1.93,1.97-.82.48-1.72.72-2.7.72s-1.91-.24-2.73-.72c-.82-.48-1.47-1.13-1.93-1.97-.47-.83-.7-1.76-.7-2.78s.23-1.95.7-2.78c.47-.83,1.11-1.49,1.93-1.97.82-.48,1.73-.72,2.73-.72s1.88.24,2.7.72c.82.48,1.47,1.13,1.93,1.97.47.83.7,1.76.7,2.78s-.23,1.95-.7,2.78Z"/>
              </g>
            </svg>
          </div>
        </div>
