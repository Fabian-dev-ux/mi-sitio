...
const Navbar = () => {
  ...
  // Funciones y efectos existentes (sin cambios)
  ...
  const handleNavigation = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    ...
    if (isMenuOpen) {
      handleCloseMenu().then(() => {
        if (isSamePageAnchor && pathname === '/') {
    ...
    <nav className="fixed top-0 left-0 w-full text-white px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-20 py-6 md:py-8 flex items-center justify-between z-50">
      <div className="flex items-center justify-between w-full gap-8">
        ...
        <ul className="hidden lg:flex items-center justify-center font-archivo text-gray-600 lg:text-xs 2xl:text-sm lg:space-x-3 2xl:space-x-4">
          <li><Link href="/#servicios" onClick={(e) => handleNavigation(e, '/#servicios')} className="font-regular inline-block group"><SlideTextOnHover originalText="SERVICIOS" hoverText="SERVICIOS" /></Link></li>
          <span>/</span>
          <li><Link href="/#proyectos" onClick={(e) => handleNavigation(e, '/#proyectos')} className="inline-block group"><SlideTextOnHover originalText="PROYECTOS" hoverText="PROYECTOS" /></Link></li>
          <span>/</span>
          <li><Link href="/#proceso" onClick={(e) => handleNavigation(e, '/#proceso')} className="inline-block group"><SlideTextOnHover originalText="PROCESO" hoverText="PROCESO" /></Link></li>
          <span>/</span>
          <li><Link href="/#vision" onClick={(e) => handleNavigation(e, '/#vision')} className="inline-block group"><SlideTextOnHover originalText="VISIÓN" hoverText="VISIÓN" /></Link></li>
          <span>/</span>
          <li><Link href="/contacto" onClick={(e) => handleNavigation(e, '/contacto')} className="inline-block group"><SlideTextOnHover originalText="CONTACTO" hoverText="CONTACTO" /></Link></li>
        </ul>
