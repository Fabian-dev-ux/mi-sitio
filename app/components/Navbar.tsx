...
const Navbar = () => {
  ...
  // Efecto para animar los elementos del menú cuando se abre
  useEffect(() => {
    if (isMenuOpen) {
            ...
            >
              ...
              <g>
                <g>
                  ...
                  <path
                    className="gray-100"
                    d="m131.28,24.96c-1.36-.74-2.44-1.78-3.25-3.1-.81-1.32-1.22-2.82-1.22-4.48s.41-3.16,1.22-4.48c.81-1.32,1.89-2.35,3.25-3.1,1.35-.74,2.82-1.12,4.4-1.12s3.04.37,4.4,1.12c1.35.74,2.44,1.78,3.25,3.1.81,1.32,1.22,2.82,1.22,4.48s-.41,3.16-1.22,4.48c-.81,1.32-1.89,2.35-3.25,3.1-1.36.74-2.82,1.12-4.4,1.12s-3.04-.37-4.4-1.12Zm7.1-2.83c.82-.48,1.47-1.13,1.93-1.97.47-.83.7-1.76.7-2.78s-.23-1.95-.7-2.78c-.47-.83-1.11-1.49-1.93-1.97-.82-.48-1.72-.72-2.7-.72s-1.91.24-2.73.72c-.82.48-1.47,1.13-1.93,1.97-.47.83-.7,1.76-.7,2.78s.23,1.95.7,2.78c.47.83,1.11,1.49,1.93,1.97.82.48,1.73.72,2.73.72s1.88-.24,2.7-.72Z"
                  />
                  <path
                    className="gray-100"
                  ...
                  <g>
                    <path
                      className="gray-100"
                      d="m111.57,24.96c-1.36-.74-2.44-1.78-3.25-3.1-.81-1.32-1.22-2.82-1.22-4.48s.41-3.16,1.22-4.48c.81-1.32,1.89-2.35,3.25-3.1,1.35-.74,2.82-1.12,4.4-1.12s3.04.37,4.4,1.12c1.35.74,2.44,1.78,3.25,3.1.81,1.32,1.22,2.82,1.22,4.48s-.41,3.16-1.22,4.48c-.81,1.32-1.89,2.35-3.25,3.1-1.36.74-2.82,1.12-4.4,1.12s-3.04-.37-4.4-1.12Zm7.1-2.83c.82-.48,1.47-1.13,1.93-1.97.47-.83.7-1.76.7-2.78s-.23-1.95-.7-2.78c-.47-.83-1.11-1.49-1.93-1.97-.82-.48-1.72-.72-2.7-.72s-1.91.24-2.73.72c-.82.48-1.47,1.13-1.93,1.97-.47.83-.7,1.76-.7,2.78s.23,1.95.7,2.78c.47.83,1.11,1.49,1.93,1.97.82.48,1.73.72,2.73.72s1.88-.24,2.7-.72Z"
                    />
                    <path
                      className="gray-100"
